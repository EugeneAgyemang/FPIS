...
{
    public partial class CreateAnalysisRequestFinishedProducts : MaterialForm
    {
        ...
        public CreateAnalysisRequestFinishedProducts()
        {
            InitializeComponent();
        ...
        private void materialButtonAddSample_Click_1(object sender, EventArgs e)
        {
            AddAnalysisSampleFormForFinishedProducts addAnalysisSampleFormForFinishedProduct = new()
            {
                AnalysisType = "Production"
            };
            addAnalysisSampleFormForFinishedProduct.ShowDialog();
        }

        private void materialButtonRequestAnalysis_Click_1(object sender, EventArgs e)
        {
            try
            {
