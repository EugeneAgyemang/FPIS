...
namespace FPIS.Migrations
{
    ...
    [Migration("20230829234359_Change_Value_DataType_Of_SampleResultsDetailsWithParameters_To_String")]
    partial class ChangeValueDataTypeOfSampleResultsDetailsWithParametersToString
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FPIS.Models.ProcurementLocation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ProcurementLocations");
                });
            ...
            modelBuilder.Entity("FPIS.Models.Releasing", b =>
                {
                    ...
                    b.HasOne("FPIS.Models.ProcurementLocation", "ProcurementLocation")
                        .WithOne("Releasing")
                        .HasForeignKey("FPIS.Models.Releasing", "ProcurementLocationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
